...
export function render(container) {
  ...
  root.appendChild(div({ class: 'card' },
    ...
    div({ class: 'muted small' }, 'Download the JSON config and the Node companion script, then run it on your machine to get push alerts for highly-ranked free agents — and for any player on your Targets list when they hit free agency. Re-export whenever you change thresholds or your Targets list.'),
    div({ class: 'btn-row' },
